package Advanced_ExamPreparation1;
...
public class Cooking {
    public static void main(String[] args) {
        ...
        while (!liquids.isEmpty() && !ingredients.isEmpty()) {
            ...
            if (cookedFood != null) {
                cookedFoods.put(cookedFood, cookedFoods.get(cookedFood) + 1);
            } else {
        ...
        String remainingIngredients = ingredients.isEmpty() ? "none" : ingredients.stream().map(String::valueOf).collect(Collectors.joining(", "));
