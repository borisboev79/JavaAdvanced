package Advanced_ExamPreparation_Exercises.Matrices;
...
public class FormulaOne {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 0; row < matrixSize; row++) {
            ...
            if (line.contains("P")) {
                ...
                playerCurrentCol = line.indexOf("P");
    ...
    private static void movePlayer(char[][] matrix, int r, int c) {
        ...
        if(playerNextPosition == 'F') {
            ...
            matrix[playerNextRow][playerNextCol] = 'P';
            reachedFinish = true;
            return;
            ...
            if(matrix[playerCurrentRow][playerCurrentCol] == 'F') {
                matrix[playerCurrentRow][playerCurrentCol] = 'P';
                reachedFinish = true;
            } else {
                matrix[playerCurrentRow][playerCurrentCol] = 'P';
            }
