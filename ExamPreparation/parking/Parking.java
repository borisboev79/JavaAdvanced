package Advanced.Advanced_ExamPreparation_Exercises.DefiningClasses.parking;
...
public class Parking {
    ...
    public boolean remove(String manufacturer, String model) {
        return this.data.remove(this.data.stream().filter(m -> m.getManufacturer()
                .equals(manufacturer) && m.getModel().equals(model)).findFirst().orElse(null));
    }
